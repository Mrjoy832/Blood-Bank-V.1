...
body{
    ...
    <body>
          <h1 style="text-align: center;font-family:Neuton,serif; font-size:40px;"><?php echo $_SESSION['NameToDisplay']?>'s Donation History</h1>
...
$select ="select * from bloodtransaction where Email='$Mail' and TransactionType='D'";
