...
body{
    ...
    <body>
    <h1 style="text-align: center;font-family:Neuton,serif;">All Blood Transactions since Last Week</h1>
...
$select ="select * from bloodtransaction where Time >= DATE_SUB(NOW(), INTERVAL 7 DAY)";
